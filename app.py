...
cred = credentials.Certificate('mindiser3-firebase-adminsdk-mcsg8-4690de41f8.json')  # Replace with the path to your JSON file
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://mindiser3-default-rtdb.firebaseio.com'  # Replace with your database URL
})
